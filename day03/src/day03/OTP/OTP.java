...
public class OTP {
    ...
    public static void encryptFile(
        ...
        // to keep things simple we will not use a buffer
        // normally, it is used to make the code more efficient
        ...
        while(true) {
            ...
            byte[] cipherStream = encryptDecrypt(Arrays.copyOfRange(buffer, 0, noBytes), keyStream);
